        ...
        return (
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-700 leading-9 text-lg">
                Agriculture is one of the most essential sectors for ensuring
                food security worldwide. By integrating Artificial Intelligence
                (AI), we are transforming the way farming is done. AI tools
                enable farmers to make better decisions on planting, harvesting,
                irrigation, and pest control, leading to more sustainable and
                efficient agricultural practices. Our AI-powered platform
                provides real-time data analysis, crop prediction models, and
                resource optimization, helping farmers increase yields and
                reduce costs. With the ability to predict market prices, monitor
                soil health, and analyze weather patterns, AI can enable farmers
                to optimize their entire operation.
              </p>
            </div>
        ...
        return (
            ...
            <div className="space-y-4 text-gray-700 leading-9 text-lg">
              ...
              <p className="text-gray-700 leading-9 text-lg">
                ...
                navigate. Follow these steps to make the most out of it:
              </p>
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>
                  ...
                  analytics tools to assess your crop's health, market trends,
                  and suggested actions.
                </li>
                <li>
                  <strong>Receive Recommendations:</strong> Based on your crop
                  data and environmental factors, receive actionable insights
                  such as irrigation schedules, pest management advice, and
